/** @file
  UniPhier UART Serial Port library functions

  (C) Copyright 2014 Hewlett-Packard Development Company, L.P.<BR>
  Copyright (c) 2006 - 2019, Intel Corporation. All rights reserved.<BR>
  Copyright (c) 2018, AMD Incorporated. All rights reserved.<BR>
  Copyright (c) 2020, Socionext Inc. All rights reserved.<BR>

  SPDX-License-Identifier: BSD-2-Clause-Patent

  Based on BaseSerialPortLib16550.c
...
//
// UniPhier UART register offsets and bitfields
//
#define R_UART_RXBUF          0x00
#define R_UART_TXBUF          0x00
#define R_UART_IER            0x04
#define R_UART_FCR            0x0c
#define   B_UART_FCR_FIFOE    BIT0
#define R_UART_LCR            0x11
...
#define R_UART_DLR            0x24

/**
  Read an 8-bit UART register.

  @param  Base    The base address register of UART device.
  @param  Offset  The offset of the UART register to read.

  @return The value read from the UART register.
...
/**
  Write an 8-bit UART register.

  @param  Base    The base address register of UART device.
  @param  Offset  The offset of the UART register to write.
  @param  Value   The value to write to the UART register specified by Offset.

  @return The value written to the UART register.
...
/**
  Retrieve the MMIO base address register for the UART device.
  ...
  )
{
  ...
  //
  // Perform platform specific initialization required to enable use of the UART device
  ...
  //
  Initialized = TRUE;
  if (SerialPortReadRegister (SerialRegisterBase, R_UART_LCR) != PcdGet8 (PcdSerialLineControl)) {
    Initialized = FALSE;
  }
  CurrentDivisor =  SerialPortReadRegister (SerialRegisterBase, R_UART_DLR);
  ...
  // Configure baud rate
  //
  SerialPortWriteRegister (SerialRegisterBase, R_UART_DLR, Divisor);
  ...
  SerialPortWriteRegister (SerialRegisterBase, R_UART_FCR, (UINT8)(PcdGet8 (PcdSerialFifoControl) & (B_UART_FCR_FIFOE)));
  ...
  )
{
  ...
  SerialPortWriteRegister (SerialRegisterBase, R_UART_LCR, Lcr);
